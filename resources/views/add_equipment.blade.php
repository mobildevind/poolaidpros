                  ...
                  <!--       <span class="tools pull-right">
                   ...
                   <!--   <header class="panel-heading">
                        ...
                        <div id="wizard" style="    padding: 15px;">
                            <section>
                           <form action="{{ route('admin.insert-equipment') }}" method="post" class="form-horizontal" enctype="multipart/form-data" id="form-submit"> 
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                   ...
                                   <div class="form-group {{ ($errors->has('type')) ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="name"  class="form-control" autocomplete="off" placeholder="Name" value="" >
                                        @if ($errors->has('title'))
                               ...
                               <!--  <a href="#" class="btn btn-danger fileupload-exists" data-dismiss="fileupload"><i class="fa fa-trash"></i>remove</a>
                                --> </div>
                                 ...
                                 <!-- <div class="form-group {{ ($errors->has('type')) ? 'has-error' : '' }}">
                                    <label class="col-lg-2 control-label">Photo: </label>
                                    <div class="col-lg-8">
                                    <input type="file" name="file" placeholder="File" value=""   class="form-control">
...
<script>
    ...
    $("form#form-submit").validate({
        ...
        "rules": {
            ...
            "name": "required",
            "keyword": "required",
            "file": {required:true,accept: "image/*"},
...
error.insertAfter($(element).parents(".fileupload.fileupload-new"));
} else  if ($(element).attr("name") == "location[]") {
error.insertAfter($(element).parents(".radios"));
}
else {
