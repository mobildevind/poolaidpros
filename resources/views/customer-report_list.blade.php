            ...
            <div class="col-sm-12">
                <section class="panel">
                    ...
                    <div class="adv-table editable-table ">
                        ...
                        <table data-ajax-url="{{ route('customer_report_list_view') }}" class="table table-striped table-hover table-bordered reloadajax" id="editable-sample" data-order-type="DESC" data-order-cols="1">
                            ...
                            <thead>
                                <tr>
                                        ...
                                        <th data-table-search="true" data-table-sort="true" data-name="first_name" >first_name</th>
                                        <th data-table-search="true" data-table-sort="true" data-name="first_name" >first_name </th>
