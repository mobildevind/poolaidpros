                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="wizard" style="    padding: 15px;">
                            <section>
                             <?php if($id == ''){ 
                              $url = 'insert-ctechnician';
                              } else { 
                              $url = 'insert-technician';
                              } ?>
                           <form action="{{ route($url) }}" method="post" class="form-horizontal" enctype="multipart/form-data" id="form-submit"> 
                                ...
                                <div class="form-group {{ ($errors->has('type')) ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="exp" class="form-control" placeholder="Exprience" value="" onkeypress="return KeycheckOnlyNumeric(event);" >
                                        @if ($errors->has('exp'))
                                        <p class="help-block">{{ $errors->first('exp') }}</p>
                                        @endif
                                    </div>
                                ...
                                <div class="form-group {{ ($errors->has('type')) ? 'has-error' : '' }}">
                                 ...
                                 <div class="form-group {{ ($errors->has('type')) ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-lg-8 date-input-custom">
                                        <div data-date-viewmode="years" data-date-format="yyyy-mm-dd" data-date="{{@date('Y-m-d')}}"  class="input-append date date">
                                            <input type="text" readonly="" style="background-color: #fff;"  placeholder="Date of birth" id="end" name="dob" value="" size="16" class="form-control">
                              ...
                              <div class="col-md-8">
                               ...
                               <!--  <div class="form-group {{ ($errors->has('type')) ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" name="salary" class="form-control" placeholder="Salary" value="" onkeypress="return KeycheckOnlyNumeric(event);" >
                                        @if ($errors->has('salary'))
                                        <p class="help-block">{{ $errors->first('salary') }}</p>
                                        @endif
                                    </div>
                                    <div class="col-lg-4">
                                    <select class="form-control ng-pristine ng-valid ng-touched" name="salary_recurrency" id="salary_recurrency" ng-model="vm.employee.salary_recurrency">
                                        <option value="">-- Recurrency --</option>
                                ...
                                <div class="form-group {{ ($errors->has('type')) ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="interests" class="form-control" placeholder="interests" value="" >
                                 ...
                                 <div class="form-group {{ ($errors->has('type')) ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="fevoriteshows" class="form-control" placeholder="Fevorite shows" value=""  >
                                ...
                                <div class="form-group {{ ($errors->has('type')) ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="fevoritebook" class="form-control" placeholder="Fevorite Book" value="" >
   ...
   var cpassword_messages = {
    ...
    $("form#form-submit").validate({
        ...
        "rules": {
            ...
            "password": "required",
            "username": "required",
            "cpass": {"required": true, "equalTo": "input:password[name='password']"},
        ...
        "messages": {
            ...
            "ccode": "The Country code field is required",
             ...
             "exp": "The Exprience field is required",
