            ...
            <section class="panel">
                ...
                <div class="panel-body static_page">
                    <div class="adv-table editable-table ">
                         ...
                         <div class="clearfix">
                                <div class="btn-group">
                                    <a id="add_static_page" class="btn btn-primary" href="{{ route('add-subscription') }}"> <i class="fa fa-plus"></i> Add New Subscription Plan</a>
                                </div>                                
                            </div>  
                        <div class="space15"></div>
                        
                        <table data-ajax-url="{{ route('get_subscription_plan_list') }}" class="table table-striped table-hover table-bordered" id="editable-sample" data-order-type="DESC" data-order-cols="1">
                            <thead>
                                <tr>
                                <th data-table-search="false" data-table-sort="true" data-name="DT_Row_Index" >ID</th>

                                    <th data-table-search="true" data-table-sort="true" data-name="plantitle" >Plan Title</th>
                                    <th data-table-search="true" data-table-sort="true" data-name="price" >Price</th>
                                    <th data-table-search="true" data-table-sort="true" data-name="days" >Day of Plan</th>
