            ...
            <section class="panel">
                ...
                <div class="panel-body static_page">
                    <div class="adv-table editable-table ">
                         ...
                         <div class="clearfix">
                                <div class="btn-group">
                                    <a id="add_static_page" class="btn btn-primary" href="{{ route('add-company') }}"> <i class="fa fa-plus"></i> Add New Company</a>
                                </div>                                
                            </div>  
                        <div class="space15"></div>
                        
                        <table data-ajax-url="{{ route('get_company_list_view') }}" class="table table-striped table-hover table-bordered" id="editable-sample" data-order-type="DESC" data-order-cols="1">
                            <thead>
                                <tr>
                                        <th data-table-search="false" data-table-sort="true" data-name="DT_Row_Index" >ID</th>
                                        
                                         <th data-table-search="true" data-table-sort="true" data-name="image" >Logo</th>
                                        <th data-table-search="true" data-table-sort="true" data-name="name" >Company</th>
                                        <th data-table-search="true" data-table-sort="true" data-name="phone" >Phone</th>
                                        <th data-table-search="true" data-table-sort="true" data-name="email" >Email</th>
                                        <th data-table-search="true" data-table-sort="true" data-name="numberofcustomer" >Customers</th>
                                        <th data-table-search="true" data-table-sort="true" data-name="numberoftechnician" >Technicians</th>
