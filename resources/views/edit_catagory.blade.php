                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="wizard" style="    padding: 15px;">
                            <section>
                           <form action="{{ route('update-catagroy') }}" method="post" class="form-horizontal" enctype="multipart/form-data" id="form-submit"> 
                                ...
                                <input type="hidden" name="userid" class="form-control"  value="<?php echo $id; ?>" >
                                 ...
                                 <div class="form-group {{ ($errors->has('type')) ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="name" class="form-control" placeholder="Catagory" value="{{@$companycat['companycat']->name}}" >
                                        @if ($errors->has('title'))
                                  ...
                                  <div class="form-group {{ ($errors->has('type')) ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-lg-8">
                                       <textarea name="description" class="form-control" placeholder="Description">{{@$companycat['companycat']->description}}</textarea>
                                        @if ($errors->has('Email'))
                                 ...
                                 <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <button type="submit" class="btn btn-success submit_button">Update</button>
                                              <a href="{{ route('service_catagory', ['id' => $id]) }}" class="btn btn-warning">Back</a>
