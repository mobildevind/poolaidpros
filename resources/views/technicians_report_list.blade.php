            ...
            <div class="col-sm-12">
                <section class="panel">
                    ...
                    <div class="adv-table editable-table ">
                        ...
                        <table data-ajax-url="{{ route('technicians_report_list_view') }}" class="table table-striped table-hover table-bordered reloadajax" id="editable-sample" data-order-type="DESC" data-order-cols="1">
                       
                            <thead>
                                <tr>
                                        <th data-table-search="false" data-table-sort="true" data-name="DT_Row_Index" >ID</th>
                                        <th data-table-search="true" data-table-sort="true" data-name="companyname" >Company Name</th>
                                        <th data-table-search="true" data-table-sort="true" data-name="first_name" >First Name</th>
                                        <th data-table-search="true" data-table-sort="true" data-name="first_name" >First Name </th>
                                        <th data-table-search="true" data-table-sort="true" data-name="email" >Email</th>
                                        <th data-table-search="true" data-table-sort="true" data-name="mobile" >Mobile</th>
                                        <!-- <th data-table-search="true" data-table-sort="true" data-name="email" >Email</th> -->
                                        <!-- 
