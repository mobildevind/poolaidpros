                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="wizard" style="    padding: 15px;">
                            <section>
                           <form action="{{ route('update_user') }}" method="post" class="form-horizontal" enctype="multipart/form-data" id="form-submit"> 
                                ...
                                <div class="form-group {{ ($errors->has('type')) ? 'has-error' : '' }}">
                                  ...
                                  <div class="form-group {{ ($errors->has('type')) ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-lg-2">
                                        <input type="text" name="sccode" class="form-control" placeholder="Country code" value="{{@$user_detail['user_detail']->scountry_code}}" onkeypress="return KeycheckOnlyNumeric(event);" >
                                        @if ($errors->has('Phone'))
                                        <p class="help-block">{{ $errors->first('Phone') }}</p>
                                        @endif
                                    </div>
                                    <div class="col-lg-6">
                                        <input type="text" name="sphone" class="form-control" placeholder="Secondary Phone" value="{{@$user_detail['user_detail']->sphone}}" onkeypress="return KeycheckOnlyNumeric(event);" >
                                        @if ($errors->has('Phone'))
                                        <p class="help-block">{{ $errors->first('Phone') }}</p>
                                        @endif
                                    </div>
