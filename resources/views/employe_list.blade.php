                ...
                <div class="panel-body static_page">
                    <div class="adv-table editable-table ">
                           <div class="clearfix">
                                    ...
                                    <a id="add_static_page" class="btn btn-primary" href="{{ route('admin.uadd-employe') }}" style="float: right;"> <i class="fa fa-plus"></i> Add New Member</a>
                        ...
                        <div class="space15"></div>
                         <?php if(isset($id)){ ?>
                       <table data-ajax-url="{{ route('get_cemploye_list_view', ['id' => $id]) }}" class="table table-striped table-hover table-bordered" id="editable-sample" data-order-type="DESC" data-order-cols="1">
                        <?php }else{ ?>
                        <table data-ajax-url="{{ route('get_employe_list_view') }}" class="table table-striped table-hover table-bordered" id="editable-sample" data-order-type="DESC" data-order-cols="1">
                        <?php } ?>
                            <thead>
                                <tr>
                                        <th data-table-search="false" data-table-sort="true" data-name="DT_Row_Index" >ID</th>
                                         <th data-table-search="true" data-table-sort="true" data-name="image" >Photo</th>
                                          <th data-table-search="true" data-table-sort="true" data-name="company" >Company</th>
                                        <th data-table-search="true" data-table-sort="true" data-name="first_name" >Member</th>
                                        <th data-table-search="true" data-table-sort="true" data-name="position" >Position</th>
