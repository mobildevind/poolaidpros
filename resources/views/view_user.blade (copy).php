                                ...
                                <div class="form-group {{ ($errors->has('type')) ? 'has-error' : '' }}">
                                 ...
                                 <div class="form-group {{ ($errors->has('type')) ? 'has-error' : '' }}">
                                  ...
                                  <div class="form-group {{ ($errors->has('type')) ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="position" readonly="readonly" class="form-control" placeholder="Name" value="{{@$user_detail['user_detail']->position}}" >
                                        @if ($errors->has('title'))
                                        <p class="help-block">{{ $errors->first('title') }}</p>
                                        @endif
                                    </div>
                                ...
                                <div class="form-group {{ ($errors->has('type')) ? 'has-error' : '' }}">
                                 ...
                                 <div class="form-group">
                                   ...
                                   <!--          <button type="submit" class="btn btn-success submit_button">Update</button> -->
                                            <a href="{{ route('get_cemploye_list', ['id' => $id]) }}" class="btn btn-warning">Back</a>
                                        </div> 
                                    </div>  
                            </form>
                            </section>
