            ...
            <section class="panel">
                ...
                <div class="panel-body static_page">
                    ...
                    <div class="adv-table editable-table ">
                           <div class="clearfix">
                                <div class="btn-group">
                                    <a id="add_static_page" class="btn btn-primary" href="{{ route('add-user', ['id' => $id]) }}"> <i class="fa fa-plus"></i> Add New Customer</a>
                                </div>                                
                            </div>  
                        ...
                        <?php } ?>
                            <thead>
                                <tr>
                                        ...
                                        <th data-table-search="true" data-table-sort="true" data-name="first_name" >User Name</th>
