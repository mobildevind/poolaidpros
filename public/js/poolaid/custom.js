    ...
    return {
        ...
        assignDataTable: function($table,pageName){
            ...
            DataTable = $($table).DataTable({
                ...
                "sDom": "<'row'<'col-lg-6 custom_print_option'l B><'col-lg-6'f> r><'responsive-tables' t><'row'<'col-lg-6 custom_pagination_class'i><'col-lg-6'p>>",
...
//            }
                ...
                "ajax": {
                    ...
                    "data": function (aoData) {
                        ...
                        aoData.search_company = $('#search_company').val();
                        aoData.minDate = $('#start').val();
                        aoData.maxDate = $('#end').val();
